...
var GraphQLError2 = class extends Error {
  constructor(e3, r, i2, n2, a3, t3, l2) {
    super(e3);
    this.name = "GraphQLError";
    this.message = e3;
    if (a3) {
...
function value(e3) {
  ...
  if (91 === i.charCodeAt(n)) {
    ...
    } else if (null != (r = a3[o.BlockString])) {
      return {
        kind: "StringValue",
        value: blockString(r.slice(3, -3)),
        block: true
      };
    } else if (null != (r = a3[o.String])) {
      return {
        kind: "StringValue",
        value: u.test(r) ? JSON.parse(r) : r.slice(1, -1),
        block: false
      };
    } else if (null != (r = a3[o.Enum])) {
      return {
        kind: "EnumValue",
        value: r
      };
...
// node_modules/.pnpm/gql.tada@1.8.9_graphql@16.9.0_typescript@5.6.2/node_modules/gql.tada/dist/gql-tada.mjs
var a2 = 0;
...
//# sourceMappingURL=chunk-KIZ2O6HX.js.map
